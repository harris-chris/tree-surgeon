...
action_0,
 ...
 action_10,
 action_11,
 action_12 :: () => Prelude.Int -> ({-HappyReduction (L.Alex) = -}
	   Prelude.Int 
	-> (L.RangedToken)
...
happyExpList = Happy_Data_Array.listArray (0,23) ([368,23553,256,47104,1472,32848,2944,32,0,0
	])
...
action_10 (8) = happyShift action_9
