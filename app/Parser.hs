...
action_0,
 ...
 action_30,
 action_31,
 action_32 :: () => Prelude.Int -> ({-HappyReduction (L.Alex) = -}
	   Prelude.Int 
	-> (L.RangedToken)
...
happyReduce_1,
 ...
 happyReduce_15,
 happyReduce_16,
 happyReduce_17 :: () => ({-HappyReduction (L.Alex) = -}
	   Prelude.Int 
	-> (L.RangedToken)
	-> HappyState (L.RangedToken) (HappyStk HappyAbsSyn -> (L.Alex) HappyAbsSyn)
	-> [HappyState (L.RangedToken) (HappyStk HappyAbsSyn -> (L.Alex) HappyAbsSyn)] 
...
happyExpList = Happy_Data_Array.listArray (0,64) ([54528,32785,2282,640,0,0,7504,1,0,0,0,0,0,60032,32776,2,15008,20482,285,80,1,8,0,256,8,0,0,40960,574,0,0,0,0,0,0,0,60032,16392,1141,0,8192,0,0,10240,16,20,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseTreeSurgeon","exp","name","namedExpr","decParse__namedExpr__","listParse__exp__","identifier","'&'","'!'","'|'","'['","']'","file","string","let","'='","';'","in","'('","')'","%eof"]
...
action_3 (8) = happyGoto action_21
...
action_5 (8) = happyGoto action_19
...
action_8 (9) = happyShift action_17
...
happyReduction_4 (HappyAbsSyn8  happy_var_2)
	(HappyTerminal happy_var_1)
	 =  HappyAbsSyn4
		 (unTok (info happy_var_1 <-> info (last happy_var_2)) (\rng (L.Identifier n) -> EFunc rng (VarName n)) happy_var_2
	)
...
happyReduction_7 (HappyTerminal happy_var_1)
	 =  HappyAbsSyn4
		 (unTok happy_var_1 (\rng (L.String s) -> EString rng $ unQuote s)
	)
...
happyReduction_10 (HappyTerminal happy_var_1)
	 =  HappyAbsSyn5
		 (unTok happy_var_1 (\_ (L.Identifier n) -> VarName n)
	)
...
happyNewToken action sts stk
	...
	L.RangedToken L.Or _ -> cont 12;
	L.RangedToken L.LBrack _ -> cont 13;
	L.RangedToken L.RBrack _ -> cont 14;
	L.RangedToken L.File _ -> cont 15;
	L.RangedToken (L.String _) _ -> cont 16;
	L.RangedToken L.Let _ -> cont 17;
	L.RangedToken L.Eq _ -> cont 18;
	L.RangedToken L.SemiColon _ -> cont 19;
